# Intro to Data Analysis and Visualization in R {#r-sm-load-analyze-visualize}
...
Our question: Which racial group suffered the most shootings by police between 2015 and 2022, according to the Washington Post data? Let's make a pivot table.
