...
#My search found 97 of 200 census tracts, or 48.5% were below the median household income of $49,875
...
New Column With Difference Using Mutate

```{r}
baltcity_income <- baltcity_income %>% 
  mutate(x2020_gain = (x2020-x2010))
```

```{r}
baltcity_income <- baltcity_income %>% 
  mutate(x2020_pct_change = ((x2020-x2010)/x2010)*100)
```
