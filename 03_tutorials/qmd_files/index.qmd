...
-   As such, the whole book -- authored in Quarto -- in its original form is [open sourced on Github](https://github.com/smussenden/data_journalism_interactive_textbook). Pull requests welcomed!
