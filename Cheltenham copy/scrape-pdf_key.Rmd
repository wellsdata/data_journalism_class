---
title: "KEY_Cheltenham PDF and processing"
author: "Rob Wells"
date: "2025-09-25"
...
```{r}
text <- pdf_text("/Users/gizmofo/Library/CloudStorage/GoogleDrive-robwells@umd.edu/My Drive/Jour772_Data_Fall_2025/Cheltenham_Jour772/Jessup_update.pdf")
#pdf_text reads the text from a PDF file.
writeLines(text, "graves.txt")
#writeLines writes this text to a text file
...
simplified_df <- index |> 
  ...
  mutate(name = str_replace_all(name, "  • No grave photo", ""),
         name = str_replace_all(name, "No grave photo", ""),
         name = str_replace_all(name, "Jessup, Anne Arundel County, Maryland, USA", ""),
         name = str_replace_all(name, "Maryland House of Corrections Cemetery", ""),
...
write.csv(graves_df1, "jessup_deaths_11_8_2025.csv")
```
